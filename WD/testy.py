#testy do zadań. Potraktujcie to jako wstępne testy jednostkowe
import sys
...
if ('Robaczek' in dir(zad3)):
    ...
    try:
       ...
       print('[ERROR]klasa Robaczek nie może zostac zainicjowana')
else:
...
if ('Owoc' in dir(zad3)):
    ...
    try:
        owoc1 = zad3.Robaczek(x1, y1, 1)
        owoc2 = zad3.Robaczek(x2, y2, 1)
...
if ('zapisy' in dir(pliki)):
    ...
    try:
        data = zapisy.wczytaj('./test_savegame.txt')
        ...
        print('[ERROR]funkcja wczytaj nie działa')
else:
